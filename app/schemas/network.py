...
class NatRuleInfo(BaseModel):
    ...
    out_interface_list: Optional[str] = Field(default=None, description="Outbound interface list")
    in_interface: Optional[str] = Field(default=None, description="Inbound interface")
    in_interface_list: Optional[str] = Field(default=None, description="Inbound interface list")
